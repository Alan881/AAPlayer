...
class AAPlayButton: UIButton {
    ...
    fileprivate func setPauseIconImage(_ rect: CGRect) {
        ...
        context.move(to: CGPoint.init(x: 8, y: 0))
        context.addLine(to: CGPoint.init(x: 8, y: 25))
        context.move(to: CGPoint.init(x: 20, y: 0))
        context.addLine(to: CGPoint.init(x: 20, y: 25))
        context.strokePath()
    ...
    fileprivate func setPlayIconImage(_ rect: CGRect) {
        ...
        context.move(to: CGPoint.init(x: 3, y: 0))
        context.addLine(to: CGPoint.init(x: 3, y: rect.size.height))
